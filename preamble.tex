...
% Numeric (default)
\usepackage[style=numeric, sorting=none, backend=biber, maxcitenames=2, maxbibnames=99, firstinits=true, uniquename=false, uniquelist=false, url=false, doi=false, isbn=false, eprint=false, natbib=true]{biblatex}
